...
%                             **todo**
% [ ] support large files (iterations)
% [ ] support rare cases: file1 is fully covered by file2
...
%                           1.04 by L. Chi: add an optional input parameter "compression_level"
...
if is_overlap_allowed
    ...
    MV.ind_start = MV.ind_start(file_sort_ind);
    MV.ind_end   = MV.ind_end(file_sort_ind);
    MV.start     = MV.start(file_sort_ind);
    MV.count     = MV.count(file_sort_ind);
