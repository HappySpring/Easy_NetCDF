function filedim = FUN_nc_varget_sub_genStartCount_from_presaved_data( pregen_info, varname, dim_name, dim_limit )
% var_dim = FUN_nc_varget_sub_genStartCount_from_file( fn, dim_name, dim_limit, time_var_name, dim_varname )
...
for ii = 1:length( var_dim_ind )
    ...
    dim_val_now = pregen_info.file(jj).dim(tmp_ind).value;
