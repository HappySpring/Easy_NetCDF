...
% decide whether unstructured grid or not
% for unstructured grid, xlimit may be a list of explicit indexes and it can be incontiguous
if ~isempty(xlimit) && numel(xlimit) > 2
    % unstructured grid
    is_unstructured_grid = true;
else
